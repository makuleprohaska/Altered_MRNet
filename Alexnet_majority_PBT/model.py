...
class MRNet3(nn.Module):
    ...
    def __init__(self,  dropout=0.15, use_batchnorm=True, use_groupnorm=False):
        ...
        # Dropout is a hyperparameter being tuned by PBT
        self.dropout_view1 = nn.Dropout(p=dropout)
        self.dropout_view2 = nn.Dropout(p=dropout)
        self.dropout_view3 = nn.Dropout(p=dropout)
